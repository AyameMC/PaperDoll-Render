...
import org.ayamemc.paperdollrender.api.config.ConfigWidgetRegistry;
...
import org.ayamemc.paperdollrender.api.config.view.Tab;
import org.ayamemc.paperdollrender.client.gui.hud.ExtraPlayerHud;
...
public class ConfigScreen extends Screen {
    ...
    public void onClose() {
        ...
        PaperDollRender.CONFIG_PERSISTENCE.save(CONFIGS.getOptions());
    }
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (keyCode == KeyBindingHelper.getBoundKeyOf(PaperDollRender.CONFIG_KEY).getValue() && this.shouldCloseOnEsc()) {
            this.onClose();
            return true;
        }
