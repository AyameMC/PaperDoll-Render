...
package org.ayamemc.paperdollrender.client.gui.hud;
...
import org.ayamemc.paperdollrender.client.gui.hud.DataBackup.DataBackupEntry;
...
public class ExtraPlayerHud {
    private static final List<DataBackupEntry<LivingEntity, ?>> LIVINGENTITY_BACKUP_ENTRIES = ImmutableList.of(
            ...
            new DataBackupEntry<>(ExtraPlayerHud::getSwimAmount, ExtraPlayerHud::setSwimAmount),
            new DataBackupEntry<>(ExtraPlayerHud::getSwimAmountO, ExtraPlayerHud::setSwimAmountO),
            new DataBackupEntry<>(LivingEntity::isFallFlying, (e, flag) -> ExtraPlayerHud.setFallFlying(e, flag)),
            new DataBackupEntry<>(ExtraPlayerHud::getFallFlyTicks, ExtraPlayerHud::setFallFlyingTicks),
            new DataBackupEntry<>(LivingEntity::getVehicle, ExtraPlayerHud::setVehicle),
            ...
            new DataBackupEntry<>(e -> e.isOnFire(), (e, flag) -> ExtraPlayerHud.setOnFire(e, flag)) // on fire
    );
    ...
    public void render(float partialTicks) {
        if (client.level == null || client.player == null || !CONFIGS.enabled.getValue()) return;
        LivingEntity targetEntity = client.level.players().stream().filter(p -> p.getName().getString().equals(CONFIGS.playerName.getValue())).findFirst().orElse(client.player);
